...
At the beginning of the day, the deli is empty and is represented by an empty array, like `var katzDeliLine = [];`, but you don't need to code the variable, since the test scripts will create it and pass it to the functions you are about to create. 
